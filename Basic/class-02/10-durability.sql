...
-- Scenario: Gautam transfers 400 to Cooper.
BEGIN;

    UPDATE accounts SET balance = balance - 400 WHERE owner = 'Gautam';
    UPDATE accounts SET balance = balance + 400 WHERE owner = 'Cooper';
