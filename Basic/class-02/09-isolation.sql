...
BEGIN; 
    ...
    -- User A starts transferring 300 to Cooper
    UPDATE accounts SET balance = balance - 300 WHERE owner = 'Gautam';
    
    -- In User A's view (inside this transaction block), Gautam's balance is now 700.
    SELECT balance FROM accounts WHERE owner = 'Gautam'; -- Returns 700
...
-- Isolation kicks in!
    ...
    SELECT balance FROM accounts WHERE owner = 'Gautam'; 
    -- Returns 1000! 
