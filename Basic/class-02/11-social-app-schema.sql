-- ====================================================
-- CLASS 2: TOPIC 11 - REAL WORLD PROJECT
-- ====================================================

-- ----------------------------------------------------
-- PROJECT: "newgram" (Social Media App Schema)
-- ----------------------------------------------------
-- Requirements:
-- 1. Users can sign up.
...
('gautam_codes', 'gautam@newgram.in'),
('cooper_ui', 'cooper@newgram.in'),
('niasa_travels', 'niasa@newgram.in');
...
(2, 1), -- cooper likes gautam's post
(3, 1), -- niasa likes gautam's post
(1, 2); -- gautam likes cooper's post

INSERT INTO comments (user_id, post_id, comment_text) VALUES 
(2, 1, 'Great job bro!'),
(1, 3, 'Kab chal rahe hain?');

-- Check the Feed for Gautam (Post + Like Count)
SELECT 
    p.caption, 
